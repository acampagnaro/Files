...
echo "*/30 * * * * wget -qO- https://raw.githubusercontent.com/Gugabit/Files/master/getUpdates.sh | sh >> /home/ubuntu/logs/update.log" >> mycron
echo "*/10 * * * * wget -qO- https://raw.githubusercontent.com/Gugabit/Files/master/logStatus.sh | sh" >> mycron
echo "0 3 * * * sudo reboot" >> mycron
crontab mycron
rm mycron
crontab -l
